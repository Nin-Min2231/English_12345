...
class ProfileRepository {
  ...
  /// F15 — Xóa hồ sơ + toàn bộ tiến độ liên quan. `LessonProgressTable`
  /// tham chiếu `Profiles` qua khóa ngoại nhưng DB **chưa bật FK
  /// enforcement/cascade** (xem `app_database.dart`), nên phải tự xóa theo
  /// đúng thứ tự trong 1 transaction để không để lại dòng tiến độ mồ côi.
